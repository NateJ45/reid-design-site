...
export const leadMagnet = defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      type: 'string',
      description: 'Browser tab title. 50-60 chars. Leave blank to use the guide title.',
    ...
    defineField({
      ...
      type: 'text',
      rows: 2,
      description: 'Search result snippet. 150-160 chars. Leave blank to use the summary.',
