...
- **Astro 6.3.8** (pinned; the 6.4.6 bump was reverted 2026-06-11 because it broke `imageService: 'compile'` builds, see changelog + `stack-and-config.md`), TypeScript strict, `output: 'static'`. Node 22.12+.
