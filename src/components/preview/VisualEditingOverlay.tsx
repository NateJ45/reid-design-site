...
//     six-concurrent-renders overload and the reverting-text bug are written up.
//     HOW the fresh HTML lands is src/lib/preview-morph.ts: an in-place morph,
//     never a wholesale swap. That file carries the measurements; the short
//     version is that replacing <main> re-decoded every image on the page and
//     blocked the main thread for about a second, twice per keystroke.
