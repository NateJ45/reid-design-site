...
- **Grow your studio guides** — `studioPlaybook` singleton: the four professional-development guides in the "Grow your studio" panel (photographing projects, software toolkit, offering e-design, trade vendor sourcing) are editable in Studio. Seeded with researched 2026 content via `scripts/seed-studio-playbook.mjs`.
